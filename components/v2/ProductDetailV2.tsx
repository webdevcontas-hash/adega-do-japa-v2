  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hero com foto (se houver) ou ícone e gradiente da categoria */}
        <div className={`relative flex h-52 items-center justify-center overflow-hidden rounded-t-3xl ${product.image ? "bg-background" : `bg-gradient-to-br ${theme.gradient}`}`}>
          {product.image ? (
            ...
            <>
              ...
              <div className="z-10 text-white drop-shadow-lg">
                <ProductIcon name={product.name} category={product.category} icon={product.icon} className="text-[7rem]" />
              </div>
            </>
          )}
          <span
